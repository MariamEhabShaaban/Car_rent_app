    ...
    <main class="flex items-center justify-center min-h-screen py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div class="w-full max-w-3xl mx-auto">
            ...
            <div class="text-center mb-16">
                ...
                <h1 class="text-indigo-600 font-bold text-7xl sm:text-8xl mb-4">Expired Link</h1>
                
                <p class="text-gray-500 text-lg max-w-lg mx-auto">
                    Oops! The page you're looking for doesn't exist or has been moved.
                </p>
                <a href="/manage" class="text-blue text-center 600 hover:underline mb-4 inline-block">&larr; Back</a>
            </div>
